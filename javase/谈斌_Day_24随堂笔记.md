...
- 执行编译期的检查 例如:@Override   
  ...
  ![image-20210827005855022](C:/Users/Administrator/Desktop/资料/笔记/T_Day25随堂笔记.assets/image-20210827005855022.png)

- 分析代码(主要用途:替代配置文件);   用在框架里面, 注解开发

  示例一：

  ![image-20210827005908343](C:/Users/Administrator/Desktop/资料/笔记/T_Day25随堂笔记.assets/image-20210827005908343.png)

  示例二：

  ![image-20210827005926331](C:/Users/Administrator/Desktop/资料/笔记/T_Day25随堂笔记.assets/image-20210827005926331.png)
...
![image-20210827010001840](C:/Users/Administrator/Desktop/资料/笔记/T_Day25随堂笔记.assets/image-20210827010001840.png)
...
Method、Field、Construct、Class都实现了AnnotationElement的接口
...
已经学过的函数式接口:
    ...
    Comparatable<E> 接口 : 有且仅有 int compareTo(E o)  
...
Lambda表达式 是匿名内部类的简写格式!但是使用范围比匿名内部类要小得多!!
 ...
 匿名内部类 : 普通类,抽象类,所有的接口 --> 匿名内部类是对类的简写
 Lambda表达式 : 函数式接口     
